...
function Invoice({ payment }) {
  ...
  console.log("PROJECTS:", JSON.stringify(payment.projects, null, 2)); // ✅ debug
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="flex-row" style={{ marginBottom: "40px" }}>
            ...
            <div className="text-right">
              ...
              <p style={{ margin: "5px 0", fontSize: "14px", fontWeight: "600" }}>
                #{invoiceNumber}
              </p>
          ...
          <div className="flex-row" style={{ marginBottom: "40px" }}>
            <div>
              ...
              <p style={{ margin: 0, fontWeight: "700" }}>
                {payment.customerName || payment.name || "Valued User"}
              </p>
            ...
            >
              ...
              <tbody>
                {payment.projects?.map((p, i) => {
                  // ✅ Get amount correctly per project
                  const amount = Number(p?.amount ?? p?.price ?? 0);

                  // ✅ Try every possible field for project name
                  const projectName =
                    p?.projectName ||
                    p?.projectId?.title ||
                    p?.title ||
